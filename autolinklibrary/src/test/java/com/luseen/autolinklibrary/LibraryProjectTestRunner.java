...
/**
 * Provisional RobolectricTestRunner to address the regression found in
 * https://github.com/robolectric/robolectric/issues/2581. Please remove and replace with
 * RobolectricTestRunner once the above issue is fixed in a future release.
 */
